...
class Learning extends MY_Controller {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->dt_params['dt_headings'] = "learning_id,learning_name,learning_status";
...
*/
    ...
    public function upload_images(){
		...
		$formdata = $_POST['learning'];
		$filedata = $_FILES['learning'];
		$cmsID = $formdata['learning_id'];
	    ...
	    if(in_array($Nname[1],$allowEd)){
		    ...
		    $insertImage['learning_image'] = $name;
		    $insertImage['learning_image_path'] = 'assets/images/';
		    $where['where']['learning_id'] = $cmsID;
	        $status = $this->model_learning->update_model($where,$insertImage);
