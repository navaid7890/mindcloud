...
$autoload['libraries'] = array('database','session','user_agent',
    'cart',
    //'account/authentication', 'account/authorization', 
...
//$autoload['helper'] = array('html', 'links', 'form', 'url','file','fileupload','common','tkd_form','inflector','security');

$autoload['helper'] = array(
    'html', 'links', 'form', 'url','file','fileupload','common','my_form','inflector','security','cookie');
