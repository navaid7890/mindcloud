                           ...
                           <div class="row align-items-center">
                             ...
                             <div class="col-md-2">
                                 <div class="cart-img-view">
                                    <img src="<?=i('')?>car-p.png" alt="">
                                 </div>
                             </div>

                             <div class="col-md-9">
                                 <p>7- Day Access to Mind Cloud Tribe: allows you to see 7 tutorial<br> introductions from Learning Journey and Eperters Tutorials</p>
                             </div>
