          ...
          <div class="tab-pane active" id="tab_0">
            ...
            // Images only in edit mode.  
              ...
              <div class="tab-pane" id="tab_5">
                  ...
                  <div class="portlet-title">
                    <div class="caption">
                      <i class="fa fa-shopping-cart"></i><?=humanize('Learning Journey Category Image')?>
                  ...
                  <div class="portlet-body form">
                    ...
                    <!-- BEGIN FORM-->
                    <? $this->load->view("admin/learning_journey_category/image");?>
                    <!-- END FORM-->
                  </div>
                  <!-- END VALIDATION STATES-->
                </div>
...
$(function() {
  var uploader = new plupload.Uploader({
    ...
    url: BASE_URL+'admin/learning/ajax-uploadtoserver?id=<?=$form_data['learning']['learning_id']?>',
    chunk_size: '4024gb',
    max_retries: 3,
    ...
    preinit : {
        UploadComplete: function(up, files) {
          ...
          AdminToastr.success('Learning Uploaded');
