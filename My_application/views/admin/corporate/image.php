...
<form class="cmxform horizontal-form tasi-form" id="uploadCmsimage" method="POST" action="<?= $config['base_url'] ?>admin/corporate/upload_images">
    <div class="form-body">
        ...
        <input type="hidden" value="<?= $form_data['corporate']['corporate_id'] ?>" name="corporate[corporate_id]" />
        ...
        <div class="row item_set">
                    ...
                    <div class="">
                        <div data-provides="uploadfile" class="uploadfile uploadfile-new">
                            <div style="max-width: 200px; max-height: 100%;" class="uploadfile-new thumbnail">
                                <?php
                                if (!empty($form_data['corporate']['corporate_image'])) {
                                ?>
                                    <img alt="" src="<?= g('db.admin.bucketimg') ?><?= $form_data['corporate']['corporate_image'] ?>">
                                <?php
                                } else {
                                ?>
            ...
            for ($i; $i <= $max_images; $i++) { ?>
                ...
                <?php if ($form_data['corporate']['corporate_is_image' . $i]  == 1) : ?>
                            ...
                            <div class="">
                                <div data-provides="uploadfile" class="uploadfile uploadfile-new">
                                    <div style="max-width: 200px; max-height: 100%;" class="uploadfile-new thumbnail">
                                        ...
                                        <?php
                                        if (!empty($form_data['corporate']['corporate_image' . $i])) {
                                        ?>
                                            <img alt="" src="<?= g('db.admin.bucketimg') ?><?= $form_data['corporate']['corporate_image'] ?>">
                                        <?php
                                        } else {
...
<script>
    $(document).ready(function() {
        ...
        $("#saveImageCms").click(function() {
            ...
            var url = "<?= $config['base_url'] ?>admin/corporate/upload_images/";
