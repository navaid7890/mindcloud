            ...
            // Images only in edit mode.  
              if($form_data){?>
                ...
                <div class="tab-pane" id="tab_4">
                  ...
                  <div class="portlet-title">
                    <div class="caption">
                      <i class="fa fa-shopping-cart"></i><?=humanize('Videos Image')?>
                  ...
                  <div class="portlet-body form">
                    ...
                    <!-- BEGIN FORM-->
                    <? $this->load->view("admin/videos/image");?>
                    <!-- END FORM-->
                  </div>
                  <!-- END VALIDATION STATES-->
                </div>
                ...
                <div class="tab-pane" id="tab_3">
                  ...
                  <div class="portlet-title">
                    <div class="caption">
                      <i class="fa fa-shopping-cart"></i><?=humanize('Videos')?>
                          <small>Uploaded</small>
...
$(function() {
  var uploader = new plupload.Uploader({
    ...
    url: BASE_URL+'admin/videos/ajax-uploadtoserver?id=<?=$form_data['videos']['videos_id']?>',
    chunk_size: '4024gb',
    max_retries: 3,
