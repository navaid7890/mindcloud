<?php
	$video_url = '';
	if(!empty($form_data['learning_journey_content']['learning_journey_video']))
		$video_url = get_image($form_data['learning_journey_content']['learning_journey_video'],$form_data['learning_journey_content']['learning_journey_video_path']);
?>
<div class="form-body">
