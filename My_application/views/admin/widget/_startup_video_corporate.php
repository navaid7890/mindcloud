...
<?php
	...
	// 	$video_url = g('db.admin.bucket') . $form_data['startup']['startup_video_new'];
?>
...
<?php
	...
	if(!empty($form_data['startup']['startup_video_corporate']))
		...
		$video_url = 'https://mindcloud-bucket.s3.amazonaws.com/assets/videos/'.$form_data['startup']['startup_video_corporate'];
?>
<div class="form-body">
...
<a id="uploadFilecorporate" name="uploadFile" href="javascript:;"><i class="fa fa-link" aria-hidden="true"></i>
Select file</a>
</div>

<div class="form-group">
<a id="uploadcorporate" href="javascript:;" class="btn btn-danger">Upload files</a>
</div>
</div>
