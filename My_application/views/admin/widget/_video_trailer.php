<?php
	$video_url = '';
	if(!empty($form_data['movies']['movie_video_trailer']))
		$video_url = get_image($form_data['movies']['movie_video_trailer'],$form_data['movies']['movie_image_path']);
?>
<div class="form-body">
...
<div id="filelist2">Your browser doesn’t have Flashs, Silverlight or HTML5 support.</div>
<div id="container">
<div class="form-group">
<a id="uploadFile2" name="uploadFile" href="javascript:;"><i class="fa fa-link" aria-hidden="true"></i>
Select file</a>
</div>

<div class="form-group">
<a id="upload2" href="javascript:;" class="btn btn-danger">Upload files</a>
</div>
</div>
