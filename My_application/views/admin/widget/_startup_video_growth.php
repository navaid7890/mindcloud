...
<?php
	...
	if(!empty($form_data['startup']['startup_video_growth']))
		...
		$video_url = 'https://mindcloud-bucket.s3.amazonaws.com/assets/videos/'.$form_data['startup']['startup_video_growth'];
?>
<div class="form-body">
...
<a id="uploadFilegrowth" name="uploadFile" href="javascript:;"><i class="fa fa-link" aria-hidden="true"></i>
Select file</a>
</div>

<div class="form-group">
<a id="uploadgrowth" href="javascript:;" class="btn btn-danger">Upload files</a>
</div>
</div>
