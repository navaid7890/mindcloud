...
>
        ...
        <!-- //image 2 -->
       <?php if ($form_data['cms_page']['cms_page_is_image2']  == 1): ?>
        ...
        <div class="col-md-4">
            ...
            <?php
            if(!empty($form_data['cms_page']['cms_page_image2'])){
            ?>
                <img alt="" src="<?=g('base_url')?>assets/uploads/cms_page/<?=$form_data['cms_page']['cms_page_image2']?>">
            <?php
            }
            else{
            ?>
            ...
            <span class="uploadfile-new"><i class="fa fa-paper-clip"></i> Select image</span>
            <span class="uploadfile-exists"><i class="fa fa-undo"></i> Change</span>
            <input type="file" name="cms_page[cms_page_image2]" class="default">
            </span>
            <a data-dismiss="uploadfile" class="btn btn-danger uploadfile-exists" href="#"><i class="fa fa-trash"></i> Remove</a>
            </div>
            </div>
