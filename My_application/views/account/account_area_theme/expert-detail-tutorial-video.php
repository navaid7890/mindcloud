                    ...
                    <div class="tutorial-scroll-content">
                        <div class="tutorial-content">
                            ...
                            <div class="tutorial-mid hding-4 hding-3 para">
                                ...
                                <? // if(isset($tutorial_data) AND array_filled($tutorial_data)) :?>
                                <? // foreach($tutorial_data as $key=>$value):?>
                                <h5><? //= html_entity_decode($value['tutorial_name']) ?></h5>
                                <? // endforeach;?>
                                <? // endif;?>
                                <? if(isset($tutorail) AND array_filled($tutorail)) :?>
                                <? foreach($tutorail as $key=>$tutor):
                                debug($tutorail);
                                ?>
                            <ul>
                                <li><a href=""><?= $tutor['cp_tutorial_id'] ?></a></li>
                            </ul>
                        <? endforeach;?>
                        <? endif;?>
                                <div class="space"><br><br></div>
