                                    ...
                                    <div class="box-1 showfirst" style="">
                                        ...
                                        <div id="radio1" class="multi-fld">
                                            ...
                                            <div class="tab">
                                                ...
                                                <form id="form-income">
                                                    <input type="hidden" name="tool_builder_fm_income[tool_builder_user_id]" value="<?= ($this->userid) ?>">
                                                    <input type="hidden" name="tool_builder_fm_income[tool_builder_percent]" value="1">
                                                    <div class="fld-text">
                                            ...
                                            <div style="overflow:auto;">
                                                <div class="next-prevBtn" style="float:right;">
                                                    <button type="button" id="nextBtn1" onclick="nextPrev(1,'your_work?tool=10&cat=20')">Submit</button>
                                                </div>
                                            </div>
                                        </div>
