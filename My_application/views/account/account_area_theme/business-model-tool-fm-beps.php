                            ...
                            <div class="tutorial-mid tool-mid hding-4 hding-3 para">
                                <div class="tutorial-mid-content">
                                    <div class="row align-items-center">
                                        ...
                                        <? else : ?>
                                            <div class="col-lg-3 col-md-12 text-right">
                                                <a href="<?= base_url() ?>quiz/breaked"><img src="<?= base_url() ?>/assets/front_assets/images/dashboard/home/icons/dl.svg" alt=""></a>
                                            </div>
                                        <? endif; ?>
                                        ...
                                        <div id="radio1" class="multi-fld">
                                            ...
                                            <div class="tab">
                                                ...
                                                <form id="form-beps" class="next-prevBtn">
                                                    <input type="hidden" name="tool_builder_fm_beps[tool_builder_user_id]" value="<?= ($this->userid) ?>">
                                                    <input type="hidden" name="tool_builder_fm_beps[tool_builder_percent]" value="1">
                                                    <div class="fld-text">
