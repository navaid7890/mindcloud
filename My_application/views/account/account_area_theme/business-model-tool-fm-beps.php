                                            ...
                                            <form id="form-beps" class="next-prevBtn">
                                                ...
                                                <table class="table table-responsive-md">
                                                    ...
                                                    <tr class="align-items-center">
                                                        ...
                                                        <div class="fld-text mb-0">
                                                            <input type="number" name="tool_builder_fm_beps[tool_builder_price_per_unit]" value="<?= $tool['tool_builder_price_per_unit'] ?>" placeholder="0">
                                                        </div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                ...
                                                <table class="table table-responsive-md">
                                                    ...
                                                    <tr class="align-items-center">
                                                        ...
                                                        <td>
                                                        <div class="fld-text mb-0">
                                                            <input type="text" name="tool_builder_fm_beps[tool_builder_advertising]" value="<?= $tool['tool_builder_advertising'] ?>" placeholder="0">
                                                        </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class="align-items-center">
                                                        ...
                                                        <td>
                                                        <div class="fld-text mb-0">
                                                            <input type="text" name="tool_builder_fm_beps[tool_builder_accounting]" value="<?= $tool['tool_builder_accounting'] ?>" placeholder="0">
                                                        </div>
                                                        </td>
                                                    </tr>
