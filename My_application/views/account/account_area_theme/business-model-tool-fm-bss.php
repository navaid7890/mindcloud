                                        ...
                                        <div id="radio1" class="multi-fld">
                                            <div class="tab">
                                                ...
                                                <form id="form-bss" class="next-prevBtn">
                                                    <input type="hidden" name="tool_builder_fm_bss[tool_builder_user_id]" value="<?= ($this->userid) ?>">
                                                    <input type="hidden" name="tool_builder_fm_bss[tool_builder_percent]" value="1">
                                                    <div class="fld-text">
