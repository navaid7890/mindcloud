<?
class Model_course_tutorial extends MY_Model {
    /**
     * TKD course_tutorial MODEL
     *
     * @package     course_tutorial Model
     * 
     * @version     2.0
     * @since       2014 / Amazingly corrupt models Corporation Inc.
     */

    protected $_table    = 'course_tutorial';
    ...
    //     $data = $this->model_course_tutorial->find_one($param);
    //     return $data;
    // }
    ...
    //     $param['joins'][] = array(
    //         "table"=>"category" , 
    //         "joint"=>"category.category_id = course_tutorial.cp_category_id",
    //         "type" => "left"
    //         );
    //     // category_depart_id
    //     $param['joins'][] = array(
    ...
    //         "type" => "left"
    //         );
    //     $data = $this->model_course_tutorial->find_all($param);
    //     }
    //     return $data;
    // }
