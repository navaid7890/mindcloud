...
class Model_tutorial extends MY_Model {
    ...
    function __construct()
    {
        ...
        $this->pagination_params['fields'] = "tutorial_id,tutorial_name,CONCAT('https://mindcloud-bucket.s3.amazonaws.com/assets/',tutorial_image) AS tutorial_image,tutorial_status";
        parent::__construct();
