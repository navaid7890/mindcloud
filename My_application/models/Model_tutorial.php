...
class Model_tutorial extends MY_Model
{
    ...
    public function test_query($id)
    {
       ...
       $sql="SELECT
        tutorial_name, tutorial_id ,tutorial_slug ,md_mytutorial.mytutorial_user_id
       FROM md_tutorial
       LEFT JOIN md_mytutorial
       on   md_tutorial.tutorial_id = md_mytutorial.mytutorial_tutorial_id  and mytutorial_user_id =$id
       where md_tutorial.tutorial_status =1 and tutorial_free_status =1
       union
       SELECT
        tutorial_name, tutorial_id ,tutorial_slug ,md_mytutorial.mytutorial_user_id
       FROM md_tutorial
        RIGHT JOIN md_mytutorial
       on   md_tutorial.tutorial_id = md_mytutorial.mytutorial_tutorial_id   AND md_tutorial.tutorial_status =1
       where mytutorial_user_id =$id";   
