...
if ($_POST['action'] == 'authorize') {
    ...
    $requestParameters['seller_note']               = 'PayFort Recurring Payment';
    $requestParameters['seller_order_id']           = '1234-RecExample-Order';
    $requestParameters['store_name']                = 'PayFort Payment';
    $requestParameters['custom_information']        = 'PayFort Sample';
